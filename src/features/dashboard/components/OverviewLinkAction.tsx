...
export function OverviewLinkAction({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        'overview-link-action inline-flex shrink-0 items-center gap-0.5 rounded-md px-1 py-0.5 text-caption font-medium text-doqyn-muted transition-colors duration-150',
