...
export const INITIAL_CATEGORIES: DocumentCategory[] = [
  {
    ...
    icon: 'file-text',
    active: true,
    documentGroupIds: ['grp_juridico', 'grp_financeiro'],
  ...
  },
  {
    ...
    icon: 'receipt',
    active: true,
    documentGroupIds: ['grp_financeiro'],
  ...
  },
  {
    ...
    icon: 'shield-check',
    active: true,
    documentGroupIds: ['grp_rh', 'grp_diretoria'],
  ...
  },
  {
    ...
    icon: 'file-text',
    active: true,
    documentGroupIds: ['grp_compras', 'grp_diretoria'],
