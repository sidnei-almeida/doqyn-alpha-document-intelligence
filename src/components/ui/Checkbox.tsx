      ...
      >
        <span className="relative mt-0.5 flex h-4 w-4 shrink-0 items-center justify-center">
          ...
          <span
            aria-hidden
            className={cn(
              'flex h-4 w-4 items-center justify-center rounded border border-doqyn-border bg-doqyn-bg transition-colors',
              ...
              'peer-checked:border-doqyn-primary peer-checked:bg-doqyn-primary',
...
/** Alias explícito para o design system DOQYN. */
