 ...
 * Variantes de botão.
 *
 * O canto é 4px, como o resto do sistema: 8px vinha de outra família e, ao lado
 * de campos em régua e tabelas de canto reto, o botão lia como peça colada de
 * outro produto.
 */
export const buttonVariants = cva(
  [
    'inline-flex items-center justify-center gap-2 rounded-[4px] font-display text-label font-medium',
  ...
  ].join(' '),
  {
    variants: {
      variant: {
        ...
        primary:
          'border-0 bg-doqyn-new-button text-doqyn-new-button-text shadow-none hover:bg-doqyn-new-button-hover active:bg-doqyn-new-button-active disabled:bg-doqyn-card disabled:text-doqyn-subtle',
        secondary:
