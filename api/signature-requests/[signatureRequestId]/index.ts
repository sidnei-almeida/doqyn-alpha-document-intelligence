...
import { getDocumentSignatureRequest } from '../../../server/services/signatures/documentSignatureService.js';
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    const result = await getDocumentSignatureRequest(auth.ctx, auth.user, signatureRequestId);
